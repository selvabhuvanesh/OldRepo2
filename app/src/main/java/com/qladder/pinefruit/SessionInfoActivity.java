...
public class SessionInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.session_name_info);
        ...
        proceedToSchedule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    Geocoder geo = new Geocoder(SessionInfoActivity.this, Locale.getDefault());
                ...
                }catch (IOException e)
                {
                   ...
                   //finish();
                    ...
                    {
                    Toast.makeText(SessionInfoActivity.this,"Required \n--------- \nService Name \nProvider Name",Toast.LENGTH_LONG).show();
                    }
            }
